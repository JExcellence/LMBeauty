...
import styles from './WimpernliftingComparison.module.scss';

export const WimpernliftingComparison: React.FC = () => {
    return (
        <Flex
            as="section"
            id="comparison"
                ...
                >
                    ...
                    <Column className={styles.option}>
                        <Column gap="l" paddingY="xl" paddingX="l">
                            ...
                            <Button href="/wimpernverlaengerung-oldenburg" size="l" variant="secondary" fillWidth>
                                Mehr erfahren
                            </Button>
                        </Column>
                    </Column>
...
export default WimpernliftingComparison;
