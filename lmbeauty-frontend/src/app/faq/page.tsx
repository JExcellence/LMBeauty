...
import {Background, Column, Icon, RevealFx, Row, SmartLink} from '@once-ui-system/core';
                    ...
                    <Column gap="16" center className={styles.heroContent}>
                        ...
                        <RevealFx delay={0.3} translateY={20}>
                            <p className={styles.heroSubtitle}>
                                Alles, was du über Wimpernverlängerungen wissen möchtest — ehrlich und verständlich
                                erklärt.
                            </p>
                        </RevealFx>
                    </Column>
