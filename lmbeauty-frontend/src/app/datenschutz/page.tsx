                ...
                >
                    ...
                    <Column gap="m">
                        ...
                        <Text variant="body-default-m" onBackground="brand-medium">
                            ...
                            Terminbuchung oder Kontaktaufnahme. Die Datenverarbeitung erfolgt auf Grundlage von Art. 6
                            Abs. 1 lit. b DSGVO zur Vertragserfüllung.
                        </Text>
                    </Column>
                    ...
                    <Column gap="m">
                        ...
                        <Text variant="body-default-m" onBackground="brand-medium">
                            Bei der Buchung eines Termins erheben wir: Name, Telefonnummer, E-Mail-Adresse (optional),
                            gewünschte Behandlung und Terminwunsch. Diese Daten werden ausschließlich zur
                            Terminvereinbarung verwendet.
                        </Text>
                    </Column>
                    ...
                    <Column gap="m">
                        ...
                        <Text variant="body-default-m" onBackground="brand-medium">
                            Wir nutzen Instagram und WhatsApp zur Kommunikation. Diese Dienste werden von Meta Platforms
                            Ireland Limited betrieben. Weitere Informationen finden Sie in den jeweiligen
                    ...
                    <Column gap="m">
                        ...
                        <Text variant="body-default-m" onBackground="brand-medium">
                            ...
                            Datenübertragbarkeit und Widerspruch gemäß DSGVO. Sie können sich jederzeit bei einer
                    ...
                    <Column gap="m">
                        ...
                        <Text variant="body-default-m" onBackground="brand-medium">
                            ...
                            entfällt oder Sie die Löschung verlangen, sofern keine gesetzlichen Aufbewahrungspflichten
                            bestehen.
                        </Text>
                    </Column>
