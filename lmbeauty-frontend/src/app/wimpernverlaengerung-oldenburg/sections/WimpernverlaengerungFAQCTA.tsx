...
export const WimpernverlaengerungFAQCTA: React.FC = () => {
    return (
        <Flex
            as="section"
            fillWidth
                ...
                >
                    ...
                    <Column gap="s" horizontal="center" maxWidth="xs">
                        <Heading as="h2" variant="heading-strong-l" onBackground="brand-strong" align="center">
                            Noch Fragen zur Wimpernverlängerung?
                        </Heading>
                        <Text variant="body-default-m" onBackground="brand-medium" align="center">
                            In unseren FAQ findest du Antworten auf alle wichtigen Fragen zu Wimpernverlängerung, Techniken, Pflege und mehr.
                        </Text>
                    </Column>
...
export default WimpernverlaengerungFAQCTA;
