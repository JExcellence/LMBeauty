...
import { Background, Badge, Column, Fade, Flex, Heading, Row, Text, Pulse } from "@once-ui-system/core";
import styles from './WimpernliftingHero.module.scss';

export function WimpernverlaengerungHero() {
    return (
        <Flex
            zIndex={1}
            fillWidth
            ...
            horizontal="center"
            vertical="center"
            aria-label="Wimpernverlängerung Oldenburg"
            role="banner"
            style={{
                minHeight: "100vh",
            }}
                ...
                >
                    ...
                    <Column fillWidth marginTop="m" horizontal="start" m={{horizontal: "center"}}>
                        <Heading as="h1" id="hero-headline" onBackground="info-strong" className={styles.headline}>
                            Dein Traumblick <Text className={styles.accentWord}>jeden Tag</Text>
                        </Heading>
                    </Column>
                    ...
                    <Column fillWidth paddingY="s" horizontal="start" maxWidth="xs"
                        ...
                        <Text as="p" onBackground="info-strong" wrap="balance" align="inherit"
                            ...
                            Natürlich, voluminös oder glamourös – deine Wimpern, dein Style. 
                            Professionelle Wimpernverlängerung mit Einzeltechnik, Hybrid oder Volumen. 
                            4-6 Wochen perfekter Look, jeden Morgen.
                        </Text>
                    </Column>
...
export default WimpernverlaengerungHero;
