...
const extrasGroups: ServiceGroup[] = [
  {
    ...
    label: 'Liftings',
    services: [
      { id: 'wimpernlifting', title: 'Wimpernlifting', description: 'Deine Naturwimpern, nur wacher.', price: '49€', bookingUrl: '/online-booking?service=wimpernlifting' },
      { id: 'augenbrauenlifting', title: 'Augenbrauenlifting', description: 'Der Rahmen, der alles zusammenhält.', price: '49€', bookingUrl: '/online-booking?service=augenbrauenlifting' },
      { id: 'kombi-lifting', title: 'Kombi Paket', description: 'Beides zusammen – spare 13€.', price: '85€', bookingUrl: '/online-booking?service=kombi-lifting' },
    ],
  },
  {
    id: 'feinschliff',
    label: 'Feinschliff',
    services: [
      { id: 'augenbrauen-zupfen', title: 'Augenbrauen zupfen', description: 'Klare Linien, sauber gezupft.', price: '10€', bookingUrl: '/online-booking?service=augenbrauen-zupfen' },
      { id: 'augenbrauen-faerben', title: 'Augenbrauen färben', description: 'Mehr Definition, mehr Ausdruck.', price: '10€', bookingUrl: '/online-booking?service=augenbrauen-faerben' },
      { id: 'naegel-shellac', title: 'Shellac Nägel', description: 'Gepflegt bis in die Fingerspitzen.', price: '35€', bookingUrl: '/online-booking?service=naegel-shellac' },
    ],
  },
];
  ...
  return (
    <Column fillWidth gap="m">
        <Column gap="s" center paddingX="xs">
            <Heading as="h3" variant="heading-default-s" onBackground="brand-medium" align="center"><i>Oft sind es die kleinen Dinge, die einen Look komplett machen.</i></Heading>
            <Text as="p" variant="label-default-s" onBackground="brand-strong" align="center">Kleine Extras, die den Look abrunden — wenn du Lust hast.</Text>
        </Column>
      ...
      >
        {groups.map((group, groupIndex) => (
          ...
          >
            <Text as="span" variant="label-default-xs" className={styles.extrasGroupLabel} onBackground="brand-weak" align="left">{group.label}</Text>
            <Flex 
              gap="xs" 
              ...
              <Column fillWidth gap="m" paddingTop="m">
                  ...
                  <Column fillWidth gap="xs">
                      {service.details.refillPrices && service.details.refillPrices.length > 0 && (
                          <Column gap="4">
                              <Text as="span" variant="label-strong-s" onBackground="neutral-strong">Refill:</Text>
                              <Column gap="2">
                                  {service.details.refillPrices.map((refill, i) => (
                                      ...
                                      >
                                          <Text as="span" variant="body-default-xs" onBackground="neutral-medium">{refill.weeks}</Text>
                                          <Text as="span" variant="label-strong-xs" onBackground="neutral-medium">{refill.price}</Text>
                                      </Row>
                                  ))}
                              </Column>
                          </Column>
                      ...
                      {service.details.idealFor && service.details.idealFor.length > 0 && (
                          <Column gap="xs">
                              <Text as="span" variant="label-strong-s" onBackground="neutral-strong">Perfekt für:</Text>
                              <List as="ul" gap="4" style={{ padding: 0}} className={styles.includesList}>
                                  {service.details.idealFor.map((item, i) => (
                                      <ListItem style={{ padding: 0}} key={i}>
                                          <CheckIcon />
                                          <Text as="span" variant="body-default-xs" onBackground="brand-medium">{item}</Text>
                                      </ListItem>
                                  ))}
                              </List>
                          </Column>
                  ...
                  <Row vertical="end" horizontal="between">
                      <Column gap="2">
                          {service.price.prefix && (
                              <Text variant="label-default-m" onBackground="brand-strong" className={styles.pricePrefix}>
                                  {service.price.prefix}
                              </Text>
                          )}
                          <Row gap="4" vertical="center">
                              <Text variant="heading-strong-m" onBackground="brand-strong" className={styles.priceAmount}>
                                  {service.price.amount}
                              </Text>
                              <Text variant="label-strong-m" onBackground="brand-strong" className={styles.priceCurrency}>
              ...
              >
                  ...
                  <Column gap="s" fillWidth horizontal="center">
                      ...
                      >
                          ...
                          was du dir <Text as="span" onBackground="brand-medium" style={{ fontWeight: 600 }}>wünschst</Text> —
              ...
              {(showStyleQuiz || showAllServicesLink) && (
                  ...
                  >
                      ...
                      {showAllServicesLink && (
                          ...
                          >
                              <Text as="p" className={styles.allServicesLinkText}>{sectionContent.allServicesText} →</Text>
                          </SmartLink>
                      )}
                  </Flex>
              )}
