    ...
    >
      <RevealFx delay={0} translateY={20} fillWidth horizontal="start" m={{ horizontal: "center" }}>
          <Badge arrow gap="xs" background="surface">
              <Pulse/>
              <Text as="span" variant="heading-default-xl" onBackground="brand-weak">Wimpern, die begeistern</Text>
          </Badge>
      </RevealFx>

      <RevealFx delay={0.15} translateY={30} fillWidth marginTop="m" horizontal="start" m={{ horizontal: "center" }}>
      ...
      <RevealFx delay={0.3} translateY={25} fillWidth paddingY="s" horizontal="start" maxWidth="xs" m={{ horizontal: "center", align: "center" }}>
        <Text as="p" onBackground="info-strong" wrap="balance" align="inherit" className={styles.heroDescription}>
          Wimpernverlängerung, die zu dir passt – natürlich, glamourös oder irgendwo dazwischen.
          Entspann dich, ich mach den Rest.
        </Text>
      </RevealFx>

      <Flex className={styles.ctaGroup} aria-label="Hauptaktionen">
        ...
        >
          ...
          >
            ...
            <Column gap="2">
              ...
              <Text as="span" className={styles.ratingText}>5.0 auf Google</Text>
            </Column>
          </a>

          <Row background="brand-medium" radius="l">
            <IconButton
              icon="instagram"
