...
import {Background, Column, Flex, Heading, Icon, Line, RevealFx, SmartLink, Text} from '@once-ui-system/core';
        ...
        >
          ...
          <Column fillWidth gap="m" paddingTop="160" m={{ maxWidth: 100 }}>
            <RevealFx delay={0.5} translateY={20}>
              ...
              >
                <Heading as="h3" variant="heading-strong-m" onBackground="brand-strong" marginBottom="xs">
                    ...
                    >
                      <Flex gap="m" horizontal="start" vertical="center">
                        ...
                        <Column gap="2" flex={1}>
                          ...
                          {!cert.available && (
                            <Text variant="body-default-xs" onBackground="brand-medium" style={{ fontStyle: 'italic' }}>
                              Bald verfügbar
                            </Text>
                          )}
                        </Column>
            ...
            <RevealFx delay={0.6} translateY={20}>
              ...
              >
                <Icon name="shield" size="l" onBackground="brand-strong" background="brand-alpha-weak" padding="xs" radius="l" />
                <Column gap="xs" horizontal="center">
                  <Heading as="h3" variant="heading-strong-s" onBackground="brand-strong" align="center">
                    Hygienekonzept
                  </Heading>
                ...
                >
                  <Text variant="label-strong-s" onBackground="brand-strong">PDF herunterladen</Text>
                </SmartLink>
              </Column>
            </RevealFx>

            <RevealFx delay={0.7} translateY={20} center>
              <Text variant="body-default-s" onBackground="brand-medium" align="center" style={{ fontStyle: 'italic' }}>
