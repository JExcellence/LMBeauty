              ...
              <Column fillWidth maxWidth={40} gap="m">
                  ...
                  <Column gap="m">
                      <RevealFx delay={0.3} translateY={20}>
                          ...
                          >
                              Ich bin Lisa, und seit über fünf Jahren ist mein Studio in Oldenburg ein Ort,
                              an dem Schönheit und Ruhe zusammenkommen. Hier geht es nicht um Hektik oder
                              Zeitdruck – sondern um dich, deine Wünsche und das gute Gefühl danach.
                          </Text>
                      </RevealFx>
