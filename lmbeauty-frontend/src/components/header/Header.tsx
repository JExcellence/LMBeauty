...
import {Button, Column, Flex, Media, MobileMegaMenu, NavIcon, Row, Text,} from "@once-ui-system/core";
import {useAuth} from '@/contexts/AuthContext';
import {HeaderProps, NavigationItem, NavigationState} from '@/types/header';
...
const mobileMenuGroups = [
    ...
    {id: "buchung", label: "Termin buchen", href: "/#contact"},
