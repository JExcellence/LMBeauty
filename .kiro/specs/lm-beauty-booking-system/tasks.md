...
- [x] 
    1. Backend Foundation - Database and Core Entities
...
- [x] 
    2. Backend API - Treatment and Availability Services
...
- [x] 
    3. Backend API - Appointment and Loyalty Services
...
- [x] 
    5. Frontend Foundation - Shared Components and Hooks
...
- [x] 
    6. Frontend - Premium Booking Flow UI
...
- [x] 
    7. Frontend - Customer Portal (Mein Bereich)
